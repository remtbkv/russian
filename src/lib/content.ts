...
export const TYPING_LESSONS: Lesson[] = [
  {
    id: 'home',
    title: 'Home row',
    items: ['фыва олдж', 'апрол джэ', 'фара папа', 'вода рада', 'дала пора', 'жара лоро'],
  },
  {
    id: 'top',
    title: 'Top row',
    items: ['йцук енгш', 'щзхъ кене', 'кнут гену', 'щука зуек', 'шуга цуке'],
  },
  {
    id: 'bottom',
    title: 'Bottom row',
    items: ['ячсм ить', 'бю.. ясим', 'сить мять', 'бить чьи', 'юмор смич'],
  },
  {
    id: 'words',
    title: 'Common words',
